<nav class="navbar navbar-expand-lg navbar-light sticky-top" style="background-color: white;">
    ...
    <div class="collapse navbar-collapse" id="myNavbarToggler10">
        <ul class="navbar-nav mx-auto">
            <li class="nav-item">
                <a class="nav-link headings" href="index.php">Home</a>
            </li>
            <li class="nav-item">
                <a class="nav-link headings" href="aacake.php">Cakes</a>
            </li>

            <li class="nav-item">
                <a class="nav-link headings" href="aboutus.php">About</a>
            </li>
            <li class="nav-item">
                <a class="nav-link headings " href="./products.php">Menu</a>
            </li>
        </ul>
